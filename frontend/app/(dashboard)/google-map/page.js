        ...
        <div className="space-y-3 md:space-y-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Button
                        onClick={() => {
                            ...
                            if (!isDrawing) {
                                toast("Click on the map to draw property boundaries. Double-click or click first point to finish.", {
                                    icon: "✏️",
                                    duration: 4000,
                                });
                            }
            ...
            <div className="flex flex-col md:flex-row gap-3 md:gap-4 h-auto md:h-[calc(100vh-220px)]">
                ...
                <div className="flex-1 relative h-[calc(100vh-340px)] md:h-full min-h-87.5">
                    ...
                    <button
                        onClick={() => setSidebarOpen(!sidebarOpen)}
                        className="hidden md:block absolute top-20 left-3 z-10 bg-white shadow-lg rounded-lg p-2 hover:bg-gray-50 transition-colors border border-gray-200"
                    ...
                    {isDrawing && (
                        <div className="absolute top-3 left-1/2 -translate-x-1/2 z-10 bg-[#009688] text-white px-3 py-1.5 md:px-4 md:py-2 rounded-full shadow-lg text-[10px] md:text-xs font-bold uppercase tracking-wider animate-pulse text-center">
                            <span className="hidden sm:inline">Click on map to draw boundary • Double-click to finish</span>
                            <span className="sm:hidden">Tap to draw • Double-tap to finish</span>
                        </div>
                    )}
